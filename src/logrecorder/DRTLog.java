...
public class DRTLog {
    ...
    public void recordResult(String filename,String fmesure,String nfmesure,String tmeasure,
                             ...
                             int numOfpartitions,double parametors,String mutantDistribution
        ...
        try{
            ...
            sdrfmeasure,nfmesure,sdrnfmeasure,tmeasure,sdrtmeasure,String.valueOf(ftime),String.valueOf(f2time),String.valueOf(ttime)};
            for (int i = 0; i < elements.length; i++) {
